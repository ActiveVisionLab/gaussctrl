...
@dataclass
class GaussEditModelConfig(SplatfactoModelConfig):
    """Configuration for the gs."""
    _target: Type = field(default_factory=lambda: GaussEditModel)
    use_lpips: bool = True
...
class GaussEditModel(SplatfactoModel):
    """Model for gs."""

    config: GaussEditModelConfig
